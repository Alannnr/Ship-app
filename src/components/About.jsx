                ...
                <div className="row">
                    <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        <div className="row g-3">
                            <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                <img src="https://as2.ftcdn.net/v2/jpg/04/85/64/05/1000_F_485640580_vAyQtC2dWmE7SCHEeSRlFLG4D7hVeZaX.jpg" class="img-fluid" alt="..." />
                            </div>
                            <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                <div class="card">
                                    <h5 class="card-header">About us</h5>
                                    <div class="card-body">
                                        <h5 class="card-title">IN BOOKING YOUR SHIP TICKETS</h5>
                                        <p class="card-text">Find the best deals on air tickets with our budget-friendly platform! We specialize in offering the lowest fares to destinations around the globe, making travel accessible and affordable for everyone. Our easy-to-use website allows you to compare prices, book ship quickly, and embark on your next adventure without breaking the bank. Whether you're planning a weekend getaway or a long-haul journey, start saving on your airfare with us today!</p>
